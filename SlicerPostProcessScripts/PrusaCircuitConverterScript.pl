...
my $pauseCatchDwellTime = 60000;
my $strEndFDMGCode = ";END FDM G CODE\nM400\nM42 P32 S0\nG91\nG1 Z5 F6000\nG90\nG1 X5\nM400\nG4 P".$pauseCatchDwellTime." ; Dwell to catch component insertion pause.\n\nCIRCUIT STARTS HERE\n\n";

my $dwellTimeBeforeRetraction = 50;	#ms
my $dwellTimeAfterRetractionCompensation = 150; #ms
...
while(<>){	#loop through lines of file
	...
	#start of G Code has already been found	
		...
		if (/G28 X0  ; home X axis/){
			print "M400\nG0 Z".($curZHeight+5)." ; final raise before X home\n";
			print;
			next;
		}
...
#			print "M400\nG4 P".$pauseCatchDwellTime." ; Dwell to catch nozzle alignment pause.\n";
		}
